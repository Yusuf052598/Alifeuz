...
@section('content')
    <div class="col-lg-8" style="left: 400px;top: 87px">
        @if(!$news->isEmpty())
        <div class="container">
            <div class="header">
                <div class="head1"></div>
                @if(isset($news) and !$news->isEmpty())
                <div class="img"><img src="{{'/'.$news[0]->category->image}}" style="width: 105px; height: 107px" class="rounded" alt=""></div>
                <div class="head2">
                                ...
                                @foreach($news as $new)
                                    <div class="posts" style="padding-bottom: 1px; width: 100%">
                                        ...
                                        <div class="posts__foto">
                                            <img src="{{'/'.$new->img}}" width="100%" height="460px"  style="margin-left: 0" alt="">
                                        </div>
